...
interface SeerEmbedBlockProps {
  ...
  children: ReactNode;
  /**
   * Where the top-right link points — the resource's own page in Sentry. Omit
   * when the resource has no page, and the link is left out rather than shown
   * as a call to action that goes nowhere.
   */
