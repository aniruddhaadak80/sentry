...
export type KnownSentryApiUrls =
  ...
  | '/projects/$organizationIdOrSlug/$projectIdOrSlug/preprod/size-analysis/status-checks/skip/'
  | '/projects/$organizationIdOrSlug/$projectIdOrSlug/preprod/snapshots/status-check-rules/'
  | '/projects/$organizationIdOrSlug/$projectIdOrSlug/preprod/snapshots/status-checks/skip/'
